...
#define BOARD_CONFIG_LABEL "Minokazu Atlas V2"
...
#define DEFAULT_BOARD_LAYOUT_A {\
  {GP_ELEMENT_PIN_BUTTON, {19,  30, 5, 5, 1, 1, 16, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {31,  30, 5, 5, 1, 1, 18, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {42,  35, 5, 5, 1, 1, 17, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {48,  54, 6, 6, 1, 1, 19, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {18,  15, 3, 3, 1, 1, 15, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {28,  15, 3, 3, 1, 1, 13, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {38,  15, 3, 3, 1, 1, 14, GP_SHAPE_ELLIPSE}}\
}

#define DEFAULT_BOARD_LAYOUT_B {\
  {GP_ELEMENT_PIN_BUTTON, {73,  31, 5, 5, 1, 1, 8,  GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {85,  28, 5, 5, 1, 1, 7,  GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {97,  28, 5, 5, 1, 1, 6,  GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {109, 31, 5, 5, 1, 1, 5,  GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {74,  43, 5, 5, 1, 1, 12, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {86,  40, 5, 5, 1, 1, 11, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {98,  40, 5, 5, 1, 1, 10, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {110, 43, 5, 5, 1, 1, 9,  GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {74,  55, 5, 5, 1, 1, 27, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {86,  52, 5, 5, 1, 1, 26, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {90,  15, 3, 3, 1, 1, 21, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {100, 15, 3, 3, 1, 1, 22, GP_SHAPE_ELLIPSE}},\
  {GP_ELEMENT_PIN_BUTTON, {110, 15, 3, 3, 1, 1, 20, GP_SHAPE_ELLIPSE}}\
}
